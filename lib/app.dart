  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return Scaffold(
        ...
        body: _buildBody(connectivityStatus),
      );
    });
  }

  Widget _buildBody(ConnectivityStatus connectivityStatus) {
    if (connectivityStatus is ConnectivityUnknown) {
      return Center(
        child: Column(
    ...
    } else if (connectivityStatus is ConnectivityDisconnected) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
